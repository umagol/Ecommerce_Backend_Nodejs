...
route.post('/order', verify, async (req, res) => {
    ...
    const FindRetailer = await Retailer.findOne({RetailerName:FindProduct.RetailerName});

    const Order = new Order({
        ProductName: req.body.ProductName,
        OrderDate: new Date(),
        RetailerName: FindProduct.RetailerName,
        RetailerArea: FindRetailer.RetailerArea,
